var od=od||{};od.DeviceType={ANALOG:1,DIGITAL:2};od.DeviceCategory={LAMP:1,FAN:2,GENERIC:3,POWER_SOURCE:4,GENERIC_SENSOR:50,IR_SENSOR:51};od.CommandType={ON_OFF:1,ANALOG:2,ANALOG_REPORT:3,GPIO_DIGITAL:4,GPIO_ANALOG:5,DEVICE_COMMAND_RESPONSE:10,PING_REQUEST:20,PING_RESPONSE:21,MEMORY_REPORT:22,CPU_TEMPERATURE_REPORT:23,CPU_USAGE_REPORT:24,GET_DEVICES:30,GET_DEVICES_RESPONSE:31,isDeviceCommand:function(f){switch(f){case this.ON_OFF:return!0;case this.ANALOG:return!0;case this.ANALOG_REPORT:return!0}return!1}};
