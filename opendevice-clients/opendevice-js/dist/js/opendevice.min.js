...
var k=c.findDevice(e.deviceID);k&&k.setValue(e.value,!1)}e.type==h.GET_DEVICES_RESPONSE&&(k=d(),a(f.DEVICE_LIST_UPDATE,k))}},connectionStateChanged:function(b,d,e){console.log("DeviceManager._connectionStateChanged :"+d);a(f.CONNECTION_CHANGE,d);od.ConnectionStatus.CONNECTED==d&&a(f.CONNECTED,c.getDevices());od.ConnectionStatus.DISCONNECTED==d&&a(f.DISCONNECTED)}})};od=od||{};od.SESSION_ID="AuthToken";od.version="0.3.2";od.appID="*";od.serverURL=window.location.origin;
