...
case $1 in
start)
java -server -cp "opendevice-middleware.jar:lib/*" -Dconfig="config.js" -Dapp.port=8181 -Dapp.dir=$WEB_PATH -Dapp.mode=local  br.com.criativasoft.opendevice.middleware.Main
;;
debug)
