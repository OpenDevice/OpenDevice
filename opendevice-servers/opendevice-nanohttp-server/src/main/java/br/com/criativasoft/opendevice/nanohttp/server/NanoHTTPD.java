...
// https://github.com/psh/nanohttpd/blob/master/samples/src/main/java/fi/iki/elonen/SimpleWebServer.java

// NOTAS:
// FIXED: Erro on stoping server. dead look on stop thread.
    ...
    public void start() throws IOException {
        ...
        myThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                } while (true && ! myServerSocket.isClosed());
            }
        });
