 ...
 * @date 05/07/14.
 */
public class DeviceManagerGuiceProvider implements Provider<DeviceManager> {

    private static ThreadLocal<DeviceManager> connectionThreadLocal = new ThreadLocal<DeviceManager>();

    public static void setInstance(DeviceManager instance){
        connectionThreadLocal.set(instance);
    }
